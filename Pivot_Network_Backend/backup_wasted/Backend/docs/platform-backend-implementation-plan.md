...
> 历史规划文档。Seller Agent V2 以 `Windows 控制台 + WSL Ubuntu compute` 为正式路径时，应优先参考
> `windows-console-wsl-ubuntu-compute-migration.md`
> 和 `windows-wsl-ubuntu-compute-implementation.md`。
